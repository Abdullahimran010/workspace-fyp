...
{{--                <div class="text-center"><img src="{{asset('assets/images/logo/logo.png')}}" style="width: 250px; height: 100px; object-fit: contain" alt=""></div>--}}
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="text-center">
                            <h4>MANAGER LOGIN</h4>
                        </div>
                        <form class="theme-form" method="POST" action="{{ route('manager.login.submit') }}">
                            @csrf
...
{{--                            </div>--}}
                            <div class="form-group form-row mt-3 mb-0">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="text-center">
                                        <div class="mt-2 m-l-20">Not a Member?  <a class="btn-link text-capitalize" href="{{ route('manager.register') }}">Register Now!</a></div>
                                    </div>
                                </div>
                            </div>
                        </form>
